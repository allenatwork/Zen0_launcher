...
public abstract class Result {
    ...
    public View inflateFavorite(@NonNull Context context, @NonNull ViewGroup parent) {
        ...
        if (drawable == null)
            favoriteImage.setImageResource(R.mipmap.ic_launcher);
        else
    ...
    void displayHighlighted(String text, List<Pair<Integer, Integer>> positions, TextView view) {
    ...
    public ListPopup getPopupMenu(final Context context, final RecordAdapter parent, final View parentView) {
        ...
        menu.setOnItemClickListener((adapter1, view, position) -> {
    ...
    void recordLaunch(Context context, QueryInterface queryInterface) {
        ...
        // * to ensure the animation runs smoothlyc
