...
import fr.neamar.kiss.adapter.ResultType;
...
public class AppResult extends Result {
    ...
    public View display(final Context context, View view, FuzzyScore fuzzyScore) {
        ...
        if (appPojo.getTags().isEmpty()) {
            ...
            if (displayHighlighted(appPojo.getNormalizedTags(), appPojo.getTags(),
                    fuzzyScore, tagsView, context)) {
        ...
        appIcon.setImageDrawable(appPojo.getIcon());
